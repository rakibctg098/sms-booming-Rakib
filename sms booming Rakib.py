...
""")
  os.system("xdg-open https://www.facebook.com/profile.php?id=100080749351287&mibextid=ZbWKwL")
  sys.exit()
baner= os.system("figlet -f slant Rakib")
baner = str(baner)
baner = baner.replace("0","")
logo=f""" {baner} \033[1;37m
××××××××××××××××××××××××××××××××××××××××××××
\033[1;37m❲\033[38;5;46m+\033[1;37m❳ DEVELOPER :Md Rakib
\033[1;37m❲\033[38;5;46m+\033[1;37m❳ GITHUB    : ctgrakib098
\033[1;37m❲\033[38;5;46m+\033[1;37m❳ VERSION   : 2.0
\033[1;37m❲\033[38;5;46m+\033[1;37m❳ PROJECT   : SMS BOMBING 
\033[1;37m❲\033[38;5;46m+\033[1;37m❳ FACEBOOK  : Md Rakib 
××××××××××××××××××××××××××××××××××××××××××××"""
print(logo)
